...
public class AdministratorView extends JFrame implements IAdministrator{
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    AdministratorView frame = new AdministratorView(new User());
    ...
    public AdministratorView(User administrator) {
        ...
        JLabel viewLabel = new JLabel("View all users:");
        viewLabel.setFont(new Font("Times New Roman", Font.PLAIN, 18));
        viewLabel.setBounds(10, 489, 159, 22);
